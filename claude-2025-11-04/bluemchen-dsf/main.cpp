...
void UpdateControls() {
    ...
    switch(outputMode) {
        ...
        case DUAL_INDEPENDENT:
            ...
            float cv2val = hw.GetCvValue(Bluemchen::CV_2);
    ...
    float cv2 = hw.GetCvValue(Bluemchen::CV_2);
