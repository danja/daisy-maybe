/* res_wav.h — minimal WAV header parser
 * SPDX-License-Identifier: Apache-2.0
 *
 * Ported from the sibling `dirac` firmware in this repo. Platform-free: the
 * reader interface is implemented over FatFS `FIL` on hardware, so the parser
 * itself pulls in no libDaisy.
 *
